...
const Navbar = () => {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20 dark:bg-slate-800 dark:text-white px-4 fixed top-0 left-0 right-0 z-50 ${
  sticky
    ? "sticky-navbar bg-base-200 dark:bg-slate-600 dark:text-white duration-0 ease-in-out transition-all shadow-md"
    : ""
}`}>
  ...
  <input type="text" className="grow outline-none dark:text-white dark:bg-slate-900 rounded-md" placeholder=' Search' />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
